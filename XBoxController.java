...
/**
 * Written by FIRST Robotics Team 3710. This is a wrapper class to allow easy use of an XBox360 controller.
 * @author cyberfalcons
 */
public class XBoxController extends Joystick {
    ...
    /**
     * This one's a little tricky. Both triggers come in as one axis.
     * left is positive and right is negative.
     * Their two values add to give the result, so pressing both gives 0.
     */
    ...
    /**
     * For some reason the D-pad registers as an axis, not a button and only the x-axis shows up.
     * We have no way of using the D-pad y-axis.
     */
